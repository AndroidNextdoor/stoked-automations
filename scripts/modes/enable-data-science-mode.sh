...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Enabling Data Science Mode${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo -e "${GREEN}Data Science Mode Configured${NC}"
...
echo "  Agents: data-scientist, ml-engineer, mlops-engineer, data-engineer"
echo ""
echo -e "${YELLOW}Use cases:${NC} Data analysis, ML model training, pipeline creation, analytics"
echo -e "${BLUE}========================================${NC}"
